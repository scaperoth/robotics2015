...
public: void OnUpdate(const common::UpdateInfo & /*_info*/)
    {
        ...
        // TODO: setup gains
        const double KP = 1400, KV = 450, KI = .9;
        ...
        //abstract values for P,I, and D portions of controller
        double proportional1  = KP * perr1;
        double derivative1    = KV * derr1;
        double integral1      = KI * sum_p1_err;
        double proportional2  = KP * perr2;
        double derivative2    = KV * derr2;
        double integral2      = KI * sum_p2_err;

        // TODO: compute torques
        double tau1 = proportional1 + derivative1 + integral1;
        double tau2 = proportional2 + derivative2 + integral2;
